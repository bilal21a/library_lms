    ...
    <div class="container">
        ...
        <form  method="POST" enctype="multipart/form-data"
            ...
            <div class="fv-row mb-5 fv-plugins-icon-container">
                ...
                <input type="text" name="book_name" class="form-control form-control-solid mb-3 mb-lg-0"
                    placeholder="Book Name" value="">
                <div class="fv-plugins-message-container invalid-feedback"></div>
                @error('book_name')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            ...
            <div class="fv-row mb-5 fv-plugins-icon-container">
                ...
                <input type="text" name="desc" class="form-control form-control-solid mb-3 mb-lg-0"
