...
<li>
    <a class="{{ request()->is('categories') ? 'active' : '' }}" href="{{ route('categories.user') }}">
        <i data-acorn-icon="category" class="d-inline-block"></i>
        <span class="label">Books by Categories</span>
    </a>
</li>
<li>
    <a class="{{ request()->is('books') ? 'active' : '' }}" href="{{ route('requested_books.add_request') }}">
        <i data-acorn-icon="book" class="d-inline-block"></i>
        <span class="label">Request Books</span>
    </a>
</li>
<li>
    <a class="{{ request()->is('books') ? 'active' : '' }}" href="{{ route('categories.user') }}">
